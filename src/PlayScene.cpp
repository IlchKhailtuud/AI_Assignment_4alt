...
void PlayScene::start()
{
	...
	auto destructibleObstacle = DestructibleObstacleManager::Instance()->generateObstacle();
	destructibleObstacle->getTransform()->position.x = 400;
	destructibleObstacle->getTransform()->position.y = 400;
